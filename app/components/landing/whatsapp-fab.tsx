...
const WhatsappFab = ({ whatsappNumber = "5521999999999" }: WhatsappFabProps) => (
  <motion.a
    ...
    className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#1DA851] text-white flex items-center justify-center shadow-lg shadow-green-500/30 transition-all hover:scale-110 animate-bounce"
  >
