  ...
  >
    ...
    <div className="p-5 flex flex-col flex-1">
      <div className="flex items-center gap-2 mb-2">
        <span className="text-[11px] font-medium px-2 py-0.5 rounded bg-brand-yellow/20 text-brand-yellow tracking-wide uppercase">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.97 }}
        className="mt-4 w-full bg-brand-yellow text-brand-black font-medium py-3 rounded-md text-sm tracking-wide uppercase cursor-pointer transition-colors duration-200 hover:bg-brand-amber"
      >
        Adicionar
      </motion.button>
    </div>
